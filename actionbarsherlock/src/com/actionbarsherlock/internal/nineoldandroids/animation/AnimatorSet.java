...
/**
 * This class plays a set of {@link com.actionbarsherlock.internal.nineoldandroids.animation.Animator} objects in the specified order. Animations
 * can be set up to play together, in sequence, or after a specified delay.
 *
 * <p>There are two different approaches to adding animations to a <code>AnimatorSet</code>:
 * either the {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#playTogether(com.actionbarsherlock.internal.nineoldandroids.animation.Animator[]) playTogether()} or
 * {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#playSequentially(com.actionbarsherlock.internal.nineoldandroids.animation.Animator[]) playSequentially()} methods can be called to add
 * a set of animations all at once, or the {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} can be
...
public final class AnimatorSet extends Animator {
     ...
     * of this AnimatorSet that take targets ({@link com.actionbarsherlock.internal.nineoldandroids.animation.ObjectAnimator} and
     * AnimatorSet).
     *
     ...
     * com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator) play()} method of <code>AnimatorSet</code> is to make it possible
     * to express the dependency relationships of animations in a natural way. Developers can also
     * use the {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#playTogether(com.actionbarsherlock.internal.nineoldandroids.animation.Animator[]) playTogether()} and {@link
     * com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#playSequentially(com.actionbarsherlock.internal.nineoldandroids.animation.Animator[]) playSequentially()} methods if these suit the need,
     * but it might be easier in some situations to express the AnimatorSet of animations in pairs.
     * <p/>
     * <p>The <code>Builder</code> object cannot be constructed directly, but is rather constructed
     * internally via a call to {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)}.</p>
     * <p/>
     ...
     * </pre>
     * <p/>
     * <p>Note in the example that both {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet.Builder#before(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} and {@link
     * com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet.Builder#after(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} are used. These are just different ways of expressing the same
     * relationship and are provided to make it easier to say things in a way that is more natural,
     * depending on the situation.</p>
     * <p/>
     * <p>It is possible to make several calls into the same <code>Builder</code> object to express
     * multiple relationships. However, note that it is only the animation passed into the initial
     * {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} method that is the dependency in any of the successive
    ...
    public class Builder {
         ...
         * {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} call that created this <code>Builder</code> object.
         *
         * @param anim The animation that will play when the animation supplied to the
         * {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} method starts.
         */
         ...
         *
         * @param anim The animation that will play when the animation supplied to the
         * {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} method ends.
         */
         ...
         * {@link com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet#play(com.actionbarsherlock.internal.nineoldandroids.animation.Animator)} method to play.
         */
